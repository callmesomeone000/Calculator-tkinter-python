...
icon_image=PhotoImage(file="caculatoricon.ico")
...
label_result= Label(root,width=25,height=2,text="" ,font=("arial",30), fg='white', bg='black')
label_result.grid(row=0,column=0)
label_result.config(font=("arial",30,"bold"))
